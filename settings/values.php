...
$mainValues = [
    'banned' => '❌ | اکانت شما مسدود شده است',
    'customer_custome_plan_day' => "⏰|لطفا  تعداد روز اشتراکت رو وارد کن\n💰|هزینه هر روز: DAY-PRICE",
    'customer_custome_plan_volume'=>"🔋|لطفا مقدار گیگابایت سرویس را وارد کن\n💰|هزینه هر گیگ: VOLUME-PRICE",
    'customer_custome_plan_name'=>'نام کانفیگ رو وارد کنید ( حروف انگیلیسی و عدد باهم وارد کنید )',
    'send_user_id'=>"🀄️| آیدی عددی کاربر را ارسال کنید :",
    'enter_decrease_amount'=>"💸 | مبلغ مورد نظر برای کاهش را وارد کنید:",
    'enter_increase_amount'=>"💸 | مبلغ مورد نظر برای افزایش را وارد کنید:",
    'user_not_found'=>"🥴 | مشخصات اشتباه وارد شده است",
    ...
    'increase_wallet_cart_to_cart'=>"♻️ یک تصویر از فیش واریزی را ارسال کنید :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از تائید واریز، مبلغ مورد نظر به کیف پول شما اضافه می شود",
    'order_increase_sent'=>"🥇 سفارش شما با موفقیت ثبت شد.
    بعد از تایید به کیف پول شما اضافه می شود 💞",
    'please_send_only_image'=>"لطفا فقط عکس ارسال کنید",
    'reached_main_menu'=>"یکی از گزینه ها را انتخاب کنید
...
",
    ...
    'can_create_specific_account'=> "روی این پلن فقط AMOUNT اکانت می توان ساخت",
    'buy_account_cart_to_cart'=>"♻️ یک تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده را در یک پیام ارسال کنید :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از تایید پرداخت، کانفیگ به صورت خودکار از طریق همین ربات برای شما ارسال می شود",
    'renew_ccount_cart_to_cart'=>"♻️ یک تصویر از فیش واریزی یا شماره پیگیری -  ساعت پرداخت - نام پرداخت کننده را در یک پیام ارسال کنید :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME",
    'order_buy_sent'=>"🛍 سفارش شما با موفقیت ثبت شد.
بعد از تائید برای شما ارسال می شود",
...
🔮 نام سرویس: REMARK
💮 سفارش: FILENAME",
    'renew_order_sent'=>"✅| درخواست شما با موفقیت ثبت شد، بعد از بررسی و تمدید، کانفیگ برای شما ارسال می شود
...
",
    ...
    'select_one_to_show_detail'=> ' 🔅 یکی از سرویس های خود را انتخاب کنید :',
    'you_dont_have_config'=>'سرویسی برای شما ثبت نشده است',
...
",
    ...
    'change_bot_settings_message'=>'🔰هرکدام از امکانات ربات را که نیاز ندارید خاموش کنید !',
...
در صورت تمایل یک پیام برای کاربر ارسال کنید.",
    "not_joine_yet"=>"هنوز در کانال عضو نشدید",
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
"send_config_uuid"=>"برای دریافت مشخصات، کانفیگ خود را ارسال کنید",
...
از این بخش میتوانید خرید تکی و خرید انبوه داشته باشید و همچنین کانفیگ های خریداری شده را مدیریت کنید",
    ...
    'no_server_available'=>"😔 | در حال حاضر سرور فعالی در دسترس نیست",
    'buy_sub_select_location' => '  1️⃣ مرحله یک:

لوکیشن مورد نظر برای خرید را انتخاب کنید:',
    'the_bot_in_not_admin' => "ربات در کانال عضو نشده، اول ربات را در کانال ادمین کرده، سپس آیدی کانال را ارسال کنید",
...
دسته بندی مورد نظر خود را رو انتخاب کنید ",
...
مدت زمان سرویس: DAYS روز',
    "renewed_config_to_user"=> '✅ کانفیگ برای کاربر تمدید شد
ریمارک: REMARK
حجم سرویس: VOLUME گیگ
مدت زمان سرویس: DAYS روز',
    'sending_config_to_user'=>' در حال ارسال کانفیگ به مشتری ...',
    'config_not_found'=>"مشکلی به وجود آمده، مجدد امتحان کنید",
    'incorrect_config_name'=>"اسم وارد شده معتبر نمی باشد",
    'pay_with_tron_wallet'=>"♻️ مبلغ AMOUNT ترون را به والت زیر ارسال کرده و تکسید آیدی واریزی ترون را ارسال کنید :
